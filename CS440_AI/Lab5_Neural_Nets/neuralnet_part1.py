...
class NeuralNet(nn.Module):
    def __init__(self, lrate, loss_fn, in_size, out_size):
        ...
        self.nerualNetwork = nn.Sequential(nn.Linear(in_size,128), nn.Sigmoid(), nn.Linear(128, out_size))
        self.lrate = lrate
        self.optims = optim.SGD(self.nerualNetwork.parameters(), lr = self.lrate)
